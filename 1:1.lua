...
local function CleanText(text)
    ...
    newText = newText:gsub("Command", "⌘")
    newText = newText:gsub("Middle Mouse", "B3")
    newText = newText:gsub("Mouse Wheel Up", "WU")
    newText = newText:gsub("Mouse Wheel Down", "WD")
    newText = newText:gsub("Mouse Button", "B") 
    newText = newText:gsub("MouseButton", "B")
